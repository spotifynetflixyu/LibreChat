...
rtk rg -n "source_refs|value_state|review_state|product_price_unit_weight|compiled_formula|material_rules_lookup_idx" supabase/schema.sql supabase/migration/202606010001_phase2_canonical_quote_facts.sql
rtk git diff --check
```
