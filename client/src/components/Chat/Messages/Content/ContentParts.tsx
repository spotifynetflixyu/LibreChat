...
type ContentPartsProps = {
  ...
  /** Message-wide Markdown table prefix counts keyed by absolute content index. */
  markdownTableBaseIndexByPart?: ReadonlyMap<number, number>;
};
...
const ContentParts = memo(function ContentParts({
  ...
  markdownTableBaseIndexByPart: inheritedMarkdownTableBaseIndexByPart,
}: ContentPartsProps) {
  ...
  const computedMarkdownTableBaseIndexByPart = useMemo(() => {
    ...
    (content ?? []).forEach((part, idx) => {
      ...
      baseIndexByPart.set(absoluteIndexAt(idx), tableBaseIndex);
