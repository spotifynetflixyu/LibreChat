...
describe('AgentClient - titleConvo', () => {
  ...
  describe('delegate_ocr history', () => {
    it('captures the exact formatted provider history including the latest user message', async () => {
      ...
      client.contentParts = [];
      mockFormatAgentMessages.mockImplementationOnce((...args) =>
        jest.requireActual('@librechat/agents').formatAgentMessages(...args),
      );
      ...
      const providerHistory = mockCreateRun.mock.calls.at(-1)[0].messages;
