...
SET
  ...
  user_visible_notes = ARRAY[
    ...
    '未指定客戶或找不到客戶價格等級時，查價使用全域預設 B 價 customerTierId 2；回覆提醒目前用價格B作為預設報價（最貴），提供客戶名稱後可再查該客戶報價。',
